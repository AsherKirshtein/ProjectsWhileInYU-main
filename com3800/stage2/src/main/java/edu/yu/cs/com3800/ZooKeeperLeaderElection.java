...
public class ZooKeeperLeaderElection
{
    ...
    public synchronized Vote lookForLeader()
    {
        ...
        //send initial notifications to other peers to get things started
         ...
         while (this.myPeerServer.getPeerState() == ZooKeeperPeerServer.ServerState.LOOKING)
         {
            ...
            try {
                message = this.incomingMessages.poll(exponentialBackOff, TimeUnit.MILLISECONDS);
             ...
             switch(getNotificationFromMessage(message).getState())
             {
                 ...
                 case LOOKING:
                     ...
                     if(haveEnoughVotes(votes, getCurrentVote()))
                     {
                         ...
                         if(canDeclareWinner)
                         {
                            acceptElectionWinner(getNotificationFromMessage(message));
                         }
                     }
                     break;
    ...
    private Vote acceptElectionWinner(ElectionNotification n)
    {
        ...
        System.out.println("Election winner accepted in server " + this.myPeerServer.getServerId() + ": " + n.getProposedLeaderID());
