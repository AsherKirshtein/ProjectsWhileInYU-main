...
public class ZooKeeperLeaderElection
{
    ...
    public ZooKeeperLeaderElection(ZooKeeperPeerServer server, LinkedBlockingQueue<Message> incomingMessages)
    {
        ...
        // logger = Logger.getLogger("ZooKeeperLeaderElection");
        // logger.setUseParentHandlers(false);
        // logger.setLevel(java.util.logging.Level.ALL);
        // try
        // {
        //     fileHandler = new FileHandler("src/main/java/edu/yu/cs/com3800/stage4/log.log");
    ...
    public synchronized Vote lookForLeader()
    {
        ...
        //send initial notifications to other peers to get things started
         sendNotifications();
         //System.out.println(this.myPeerServer.getServerId() + " Sent initial notifications");
         //System.out.println(this.myPeerServer.getServerId() + " Entering the while loop");
         ...
         while (this.myPeerServer.getPeerState() == ServerState.LOOKING  || !this.observerFoundLeader)
         {
            ...
            catch (InterruptedException e)
            {
             ...
             //System.out.println(this.myPeerServer.getServerId() + ": Received a message");
             ...
             switch(getNotificationFromMessage(message).getState())
             {
                 ...
                 case LOOKING:
                     ...
                     //System.out.println(this.myPeerServer.getServerId() + ": The sender is also looking");
                     ...
                     if(supersedesCurrentVote(getNotificationFromMessage(message).getProposedLeaderID(), getNotificationFromMessage(message).getPeerEpoch()))
                     {
                        ...
                        sendNotifications();
                        //System.out.println(this.myPeerServer.getServerId() + ": The new vote supersedes mine, so I'm sending out new notifications");
                     }
                     ...
                     {
                        //System.out.println(this.myPeerServer.getServerId() + ": I have enough votes to declare " + this.proposedLeader + " as the leader");
                        //first check if there are any new votes for a higher ranked possible leader before I declare a leader. If so, continue in my election loop
                         ...
                         while(!this.incomingMessages.isEmpty())
                         {
                            ...
                            if(supersedesCurrentVote(getNotificationFromMessage(newMessage).getProposedLeaderID(), getNotificationFromMessage(newMessage).getPeerEpoch()))
                            {
                                ...
                                //System.out.println(this.myPeerServer.getServerId() + ": I couldn't declare a winner because I received a new vote for a higher ranked possible leader: " + getNotificationFromMessage(newMessage).getProposedLeaderID());
                 ...
                 //case FOLLOWING: case LEADING: //if the sender is following a leader already or thinks it is the leader
                    case FOLLOWING: case LEADING:
                     ...
                     if(haveEnoughVotes(votes, getNotificationFromMessage(message)))
                     {
                         ...
                         //System.out.println(this.myPeerServer.getServerId() + ": The sender's vote allows me to reach a conclusion based on the election epoch that I'm in");
                         myVote = acceptElectionWinner(getNotificationFromMessage(message));
                      ...
                      else
                      {
                         ...
                         if(getNotificationFromMessage(message).getProposedLeaderID() == this.proposedLeader)
                         {
                            ...
                            //System.out.println(this.myPeerServer.getServerId() + ": A quorum from that epoch are voting for the same peer as the vote of the FOLLOWING or LEADING peer whose vote I just received");
                            myVote = acceptElectionWinner(getNotificationFromMessage(message));
                         }
                         //ELSE:
                         else
                         {
                             ...
                             //System.out.println(this.myPeerServer.getServerId() + ": I'm keeping looping on the election loop I got to the end and still haven't declared a winner");
                             continue;
                         }
                      }
                      break;
        ...
        //System.out.println(this.myPeerServer.getServerId() + ": I'm exiting the election loop because I am out of the while loop and I haven't declared a winner");
        return myVote;
    }
    ...
    private Vote acceptElectionWinner(ElectionNotification n)
    {
        ...
        System.out.println("Accepting " + n.getProposedLeaderID() + " as leader my state is " + this.myPeerServer.getPeerState());
